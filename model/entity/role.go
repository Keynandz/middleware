...
func (MasterRoleModel) TableName() string {
	return "security_role"
}

func (m *MasterRoleModel) BeforeCreate(tx *gorm.DB) (err error) {
	m.Created = *date.DateTodayLocal()
	return
}

func (m *MasterRoleModel) BeforeUpdate(tx *gorm.DB) (err error) {
